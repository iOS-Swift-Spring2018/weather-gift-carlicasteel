...
//  WeatherGift
//
//  Created by Carli Casteel on 3/18/18.
...
extension DetailVC: CLLocationManagerDelegate {
    ...
    func handleLocationAuthorizationStatus(status: CLAuthorizationStatus) {
        ...
        case .restricted:
            showAlert(title: "Location services denied", message: "It may be that parental controls are retricting location use in this app.")
        }
    }
    ...
    func showAlertToPrivacySettings(title: String, message: String) {
        ...
        let settingsActions = UIAlertAction(title: "OK", style: .default) { value in UIApplication.shared.open(settingsURL, options: [:], completionHandler: nil)
        }
